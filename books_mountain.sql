...
--
-- Host: 127.0.0.1
-- Czas generowania: 13 Lut 2023, 15:18
...
(4, '2s', '12@gmail.com', '25f9e794323b453885f5181f1b624d0b', 'Siemas', 'Si'),
...
--
ALTER TABLE `users_offers`
  MODIFY `offer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
COMMIT;
